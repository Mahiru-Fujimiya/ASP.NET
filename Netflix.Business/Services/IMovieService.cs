...
public interface IMovieService
{
    ...
    Task<(List<Movie> Items, int TotalCount)> GetMoviesAsync(string? keyword, int? genreId, int? releaseYear, int page, int pageSize);
    ...
    Task RateMovieAsync(int id, int ratingValue);
}